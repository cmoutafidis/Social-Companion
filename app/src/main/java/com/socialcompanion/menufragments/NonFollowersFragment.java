...
import com.socialcompanion.service.social.instagram.adapters.CustomAdapter;
...
public class NonFollowersFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener  {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ((MainActivity)getActivity()).setActionBarTitle("Non Followers");
