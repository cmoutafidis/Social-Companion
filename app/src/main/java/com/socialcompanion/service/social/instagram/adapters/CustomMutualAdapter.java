...
public class CustomMutualAdapter extends ArrayAdapter<InstagramUserObject> implements View.OnClickListener{
    ...
    public CustomMutualAdapter(ArrayList<InstagramUserObject> data, Context context) {
        super(context, R.layout.fragment_user_display, data);
        this.dataSet = data;
    ...
    public void onClick(View v) {
        ...
        HashSet<String> set = (HashSet<String>) sharedPref.getStringSet("whitelist", new HashSet<String>());
        if(!set.contains(dataModel.getUsername())){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.fragment_user_display, parent, false);
        ...
        if(sharedPref.getStringSet("whitelist", new HashSet<String>()).contains(dataModel.getUsername())){
            viewHolder.action.setImageResource(R.drawable.block_disabled);
        }
        else{
            viewHolder.action.setImageResource(R.drawable.ic_block_black_24dp);
        }
